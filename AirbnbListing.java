...
public class AirbnbListing {
    ...
    {
        String text = "" + this.getName() + ". Located in " +
            this.getNeighbourhood() + ", owned by " + this.getHost_name() +
            ". The price is " + this.getPrice() + " per night, with a minimum stay of " +
            this.getMinimumNights() + ", and the room type is " + this.getRoom_type() +
            ". Last review: " + this.getLastReview() + ".";
        return text;
    }
}
